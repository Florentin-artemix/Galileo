  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-8">
        {/* Header - VIEWER SIMPLE */}
        <div className="mb-8">
          <div className="relative bg-gradient-to-r from-gray-600 via-gray-500 to-slate-500 rounded-2xl p-6 mb-4 shadow-lg overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-white/90">
                    Consultez les publications et événements en mode lecture
                  </p>
                </div>
                <div className="hidden md:block text-right">
                  <div className="inline-flex items-center px-4 py-2 bg-gray-400/90 rounded-full text-white font-bold shadow-lg">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                ...
                <span className="inline-flex items-center px-3 py-1 bg-white/20 rounded-full text-white text-sm">
                  <span className="mr-2">👁️</span> Voir événements
                </span>
                <span className="inline-flex items-center px-3 py-1 bg-white/10 rounded-full text-white/70 text-sm">
                  <span className="mr-2">🔒</span> Soumissions (Étudiant+)
                </span>
                <span className="inline-flex items-center px-3 py-1 bg-white/10 rounded-full text-white/70 text-sm">
                  <span className="mr-2">🔒</span> Gestion (Staff/Admin)
                </span>
              </div>
            </div>
          </div>
          <div className="p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
            <p className="text-sm text-amber-700 dark:text-amber-300">
              <strong>💡 Conseil:</strong> Pour soumettre vos propres articles, demandez le rôle <strong>Étudiant</strong> à un administrateur.
            </p>
          </div>
        </div>
...
const DashboardView = ({ stats, publications, events }: any) => (
  <div>
    {/* Upgrade Banner */}
    <div className="mb-8 p-6 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 border border-emerald-200 dark:border-emerald-800 rounded-xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-emerald-700 dark:text-emerald-400">
            En tant qu'Étudiant, vous pourrez soumettre vos articles de recherche pour publication.
          </p>
        </div>
        <NavLink 
          to="/contact" 
