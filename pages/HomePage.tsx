...
import type { Publication, Event } from '../types';
    ...
    return (
         <div className="bg-light-card dark:bg-navy/50 p-4 rounded-lg border border-light-border dark:border-dark-border flex items-center gap-4 animate-slide-in-up shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex-grow">
                 <h4 className="font-poppins font-bold text-light-text dark:text-off-white text-base leading-tight">{event.title[language]}</h4>
                 <p className="text-xs text-light-text-secondary dark:text-gray-400 line-clamp-1">{event.summary[language]}</p>
            </div>
